            ...
            public struct FilmsEdge: Codable {
                ...
                public struct Film: Codable {
                    ...
                    public struct FilmCharactersConnection: Codable {
                        public init(__typename: String = String(), characters: [FilmCharactersConnection.Person?]? = nil, pageInfo: FilmCharactersConnection.PageInfo = FilmCharactersConnection.PageInfo(), characterConnFrag: CharacterConnFrag = CharacterConnFrag()) {
                            self.__typename = __typename
                        ...
                        public init(from decoder: Decoder) throws {
                            ...
                            self.characterConnFrag = try CharacterConnFrag(from: decoder)
                        }
                        ...
                        public private(set) var characterConnFrag: CharacterConnFrag = CharacterConnFrag()
